...
import { Dimensions, LayoutAnimation, Platform, View, Text } from "react-native";
      ...
      {spiderMarkers.map(marker => (
        ...
        >
            <View style={{
                ...
                borderColor: marker.customData._5 ? '#ff8d00' : marker.customData._30 ? '#ff0c00' : '#ffe000',
                borderStyle: 'solid',
                borderWidth: 2,
                paddingHorizontal: 3,
                paddingVertical: 1,
                ...
                {runes(marker.customData.title).map((c, i) => (
                    <Text
                        style={{
                            fontSize: 8,
                            color: 'black',
